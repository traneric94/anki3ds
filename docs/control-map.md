...
same time does not save a rating. Save, reset, action-confirm, exit-open, and
exit-confirm buttons are also ignored when pressed together with another command
button.
