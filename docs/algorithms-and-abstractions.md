...
headings/status labels, Hard ratings, learning counts, and cautions; green
...
prompts; bright magenta Easy ratings and new counts; and bright white neutral
status, with dim white separators. Blue and cyan are intentionally avoided
because they are hard to read on the dark 3DS console background. Moving
